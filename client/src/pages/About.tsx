  ...
  return (
    <AnimatedSection>
      <div className="container mx-auto px-6 py-24">
        <h1 className="text-4xl font-bold text-[#2C3E50] mb-12">About Me</h1>
        
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-2xl font-semibold text-[#2C3E50] mb-6">Background</h2>
          ...
          <Card>
            <CardContent className="p-6">
              <h2 className="text-2xl font-semibold text-[#2C3E50] mb-6">Skills</h2>
              <div className="grid grid-cols-2 gap-4">
                {skills.map((skill) => (
                  <div
                    key={skill}
                    className="bg-[#3498DB]/10 text-[#2C3E50] rounded-md px-4 py-2 text-center"
                  >
                    {skill}
                  </div>
                ))}
